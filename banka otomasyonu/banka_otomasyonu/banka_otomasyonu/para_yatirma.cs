...
{
    public partial class para_yatirma : Form
    {
        ...
        private void btnParayatirma_Click(object sender, EventArgs e)
        {
            ...
            decimal yatirilacaktutar = decimal.Parse(txtTutar.Text);
            ...
            try
            {
                using (SqlConnection connection = new SqlConnection(connectionString))
                {
                    ...
                    string query = "UPDATE musteriler SET bakiye= bakiye - @yatirilacaktutar WHERE ID= @id AND adSoyad=@adSoyad";
                    using (SqlCommand command = new SqlCommand(query, connection))
                    {

                        command.Parameters.AddWithValue("@yatirilacaktutar", yatirilacaktutar);
